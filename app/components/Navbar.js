...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className="bg-white w-[80vw] flex justify-between fixed top-10 right-[10vw] rounded-full p-4 px-5">
          <div className="flex items-center gap-20 logo">
            <Link href={"/"}>
              <svg
                className="h-6"
            ...
            <ul className="flex justify-start gap-5 font-semibold text-gray-500">
              <Link className="p-2 rounded-lg hover:bg-gray-200" href="/">
                <li>Templates </li>
              </Link>
              <Link className="p-2 rounded-lg hover:bg-gray-200" href="/">
                <li>Marketplace</li>
          ...
          <div className="flex gap-3">
            <button className="p-4 font-bold bg-gray-300 rounded-lg login hover:bg-gray-400 z-1 ">
              Log in
            </button>
            <button className="p-4 font-bold text-white bg-gray-900 rounded-full signup hover:bg-[#303541] z-1">
              {" "}
              Sign up free
            </button>
          </div>
